...
save_path <- paste0(wkdir, "ggdmc_data0.rda")
source(helper_path)
...
dat <- simulate(sub_model, nsim = 128, parameter_vector = p_vector, n_subject = 1)
...
sub_samples <- initialise_theta(sub_theta_input, sub_priors, sub_dmis[[1]], seed = 846671, verbose = FALSE)
