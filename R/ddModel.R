...
#'            left vs. right response). When \code{d > 0}, responses
#' at the upper boundary are delayed by \code{d} seconds. Symmetric execution
#' is assumed when \code{d = 0} (Voss and Voss, 2007.)}
